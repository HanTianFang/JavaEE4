...
public class NewServletRequest implements ServletRequest{
	...
	public NewServletRequest(InputStream in){
		this.in = in;
		prepareBuffer();
		parseString();
	}
	...
	public AsyncContext startAsync(NewServletRequest arg0, ServletResponse arg1) throws IllegalStateException {
		// TODO Auto-generated method stub
		return null;
	}
